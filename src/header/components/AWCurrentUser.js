...
export class AWCurrentUser extends React.Component {
  ...
  constructor(props) {
    ...
    // Le menu d�roulant est ferm� par d�faut
    this.state = {open: false};
  }

  handleTouchTap = (event) => {
    console.log("AWCurrentUser.handleTouchTap() : D�but");
  ...
  handleRequestClose = () => {
    console.log("AWCurrentUser.handleRequestClose() : D�but");
  ...
  selectUser = (userId) => {
    console.log("AWCurrentUser.selectUser(" + userId + ") : D�but");
